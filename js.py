...
cl = LineClient(authToken='ExU8KTPdGEc9uv7QuHr2.judyzdUH7VmsfDiUleBNGG.4icmnouy/6mP9MBO5HA9FxDcH+BJx8PFYXLv59LSlHc=')
cl.log("Auth Token : " + str(cl.authToken))
channel = LineChannel(cl)
cl.log("Channel Access Token : " + str(channel.channelAccessToken))

ki = LineClient(authToken='ExiWyyB6w8GNjZOG7YB6.iEcvpkjC9tbpWfWR/DMfPG.QS/9je6M/TLrzthRt1cbB/Qv12mOyEe5Q3ybNTLbnXA=')
ki.log("Auth Token : " + str(ki.authToken))
channel1 = LineChannel(ki)
ki.log("Channel Access Token : " + str(channel1.channelAccessToken))

kk = LineClient(authToken='ExD0szkArjNqaOy3VfR0.FQZ8VwFjb61JIHa4Y4Ks8a.VHNBU645zSb9kOWmaEHhfQ4q4WGnA59/hOA61AB7Lxg=')
kk.log("Auth Token : " + str(kk.authToken))
channel2 = LineChannel(kk)
kk.log("Channel Access Token : " + str(channel2.channelAccessToken))

kc = LineClient(authToken='ExThudLynK9RYwX8rZ20.CqiDvAhwVcNT5QxVhXw+ya.cjmUli4V+yAl8VuTgKPv/D/6rmlMzKooxwUSZ1yCK0A=')
kc.log("Auth Token : " + str(kc.authToken))
channel3 = LineChannel(kc)
kc.log("Channel Access Token : " + str(channel3.channelAccessToken))

sw = LineClient(authToken='EwpkTlZcJ64ulUfsGMu0.oy7rSoL9QI2iYnoc1syTya.fIZgHIB/BNIN0oW/rpMF8sH5vhV0YcSdJFzgVLVuSB0=')
...
poll = LinePoll(cl)
call = LineCall(cl)
creator = ["u2540d8643ba1eef31215d22e2c46e782"]
owner = ["u2540d8643ba1eef31215d22e2c46e782"]
admin = ["u2540d8643ba1eef31215d22e2c46e782"]
staff = ["u2540d8643ba1eef31215d22e2c46e782"]
...
wait = {
    ...
    "selfbot":True,
    "mention":"۩SAY۩ 🇳​🇬​🇮​🇳​🇹​🇮​🇵​ 🇲​🇺​🇱​🇺​ 🇲​🇦​🇸​🇺​🇰​ 🇸​🇮​🇳​🇮​ 🇰​🇰​۩SAY۩\n╰━━━━━━━━━━━━━━━━\n━━━━┅═❉ই۝ई❉═┅━━━━ ",
    "Respontag":" ░▒ ƭαɠ ƭαɠ αҡµ ҡαɳɠεɳ ყα૮ɦɦɦ... ▒░",
    "Respontag2":"Selfi Dlu Kk Biar Tambah Cakep",
    "welcome":"▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀▀█\n█░░╦─╦╔╗╦─╔╗╔╗╔╦╗╔╗░░█\n█░░║║║╠─║─║─║║║║║╠─░░█\n█░░╚╩╝╚╝╚╝╚╝╚╝╩─╩╚╝░░█\n█▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄▄",
    "comment":"Like like & like by MALAIKAT",
    "message":"\n Terimakasih Sudah Add Saya\n+\n بسم الله الرحمن الرحيم",
    }
...
def welcomeMembers(to, mid):
    try:
        arrData = ""
        textx = "Total Member Masukبسم الله الرحمن الرحيم「{}」\nHaii  ".format(str(len(mid)))
        arr = []
        no = 1
        num = 2
        for i in mid:
                 ...
                 if wait["detectMention"] == True:
                   ...
                   for mention in mentionees:
                        if mention ['M'] in Bots:
                           ...
                           cl.sendMessage(msg.to, None, contentMetadata={"STKID":"16224164","STKPKGID":"1423884","STKVER":"1"}, contentType=7)
                           break
               if 'MENTION' in msg.contentMetadata.keys() != None:
                 if wait["Mentiongift"] == True:
                   ...
                   for mention in mentionees:
                        if mention ['M'] in Bots:
                           ...
                           cl.sendMessage(msg.to, "Ye kk Ngetag Mele,,,,check Pm Gih...???")
                    ...
                    if text is None:
                        ...
                        if cmd == "self on":
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                cl.sendText(msg.to,"u2540d8643ba1eef31215d22e2c46e782") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                            try:
                                ...
                                bot = runtime(eltime)
                                start = time.time()
                                cl.sendText("u2540d8643ba1eef31215d22e2c46e782", '.')
                                ...
                                cl.sendContact(to, "u2540d8643ba1eef31215d22e2c46e782")
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                            try:
                                ...
                                bot = runtime(eltime)
                                start = time.time()
                                ki.sendText("u2540d8643ba1eef31215d22e2c46e782", '.')
                                elapsed_time = time.time() - start
                                ...
                                ki.sendContact(to, "u2540d8643ba1eef31215d22e2c46e782")
                            except Exception as e:
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                            try:
                                ...
                                bot = runtime(eltime)
                                start = time.time()
                                kk.sendText("u2540d8643ba1eef31215d22e2c46e782", '.')
                                elapsed_time = time.time() - start
                                ...
                                kk.sendContact(to, "u2540d8643ba1eef31215d22e2c46e782")
                            except Exception as e:
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                            try:
                                ...
                                bot = runtime(eltime)
                                start = time.time()
                                kc.sendText("u2540d8643ba1eef31215d22e2c46e782", '.')
                                elapsed_time = time.time() - start
                                ...
                                kc.sendContact(to, "u2540d8643ba1eef31215d22e2c46e782")
                            except Exception as e:
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               image = "http://dl.profile.line-cdn.net/" + contact.pictureStatus
                               cl.sendMessage1(msg)
                               cl.sendMessage(msg.to, "Kenalin Kk Cowok Keceh Stok Akhir Tahun....")
                               cl.sendImageWithURL(msg.to,image)
                        ...
                        elif cmd == "mybot" or cmd == "mhk":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               msg.contentType = 13
                               msg.contentMetadata = {'mid': mid}
                               cl.sendMessage1(msg)
                               cl.sendMessage(msg.to, "Siap 86 Boss")
                               msg.contentType = 13
...
#===========BOT UPDATE============#
                        elif cmd == "A" or text.lower() == 'cipok':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               ...
                               for a in range(k+1):
                                    ...
                                    cl.sendMessage(to, "Jumlah Member {} คน".format(str(len(nama))))  
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"✍admin\n\nSuper admin:\n"+ma+"\n✍Admin:\n"+mb+"\n✍Staff:\n"+mc+"\n✍Total「%s」 Mhk" %(str(len(owner)+len(admin)+len(staff))))
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to,"「💀 List Protection💀 」\n\n┣💀PROTECT URL :\n"+ma+"\n┣💀PROTECT KICK :\n"+mb+"\n┣💀PROTECT JOIN :\n"+md+"\n┣💀PROTECT CANCEL:\n"+mc+"\n┣💀PROTECT INVITE:\n"+me+"\n┣💀PROTECT ANTIJS:\n"+mf+"\nTotal「%s」Group protect" %(str(len(protectqr)+len(protectkick)+len(protectjoin)+len(protectcancel)+len(protectinvite)+len(protectantijs))))
                        ...
                        elif cmd == "kicker bye" or cmd == "demit":
                            if msg._from in admin:
                                G = cl.getGroup(msg.to)
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendMessage(msg.to, "✍MHK Speed respon\n\n - Get Profile\n   %.10f\n - Get Contact\n   %.10f\n - Get Group\n   %.10f" % (get_profile_time/3,get_contact_time/3,get_group_time/3))
                        ...
                        elif cmd == "kibar cinta":
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                               cl.sendContact(to, mid)
                               cl.sendMessage(msg.to, "assalamualaikum \nCINTA DALAM KEABADIAN \nKu sebut Namamu di setiap nafasku..Ku ingat senyummu di setiap hariku,,,Betapa rindunya diri ini akan senyum ketulusan yang hanya kau berikan padaku,,Ku ingat semua kata nasehatmu sayang,,Ku ingat ungkapan cinta yang lahir dari hatimu,,,Nantikanlah aku di keabadian cinta kita..Nantikanlah kebahagiaan kita di surga nanti,,,Hapuslah air matamu dan tetaplah setia di sana.,,Ku kan tetap setia untukmu,,Ku kan tetap mencintamu,,sampai Tuhan mempertemukan kita kembali.")
                               cl.sendContact(to, Amid)
                               cl.sendMessage(msg.to, "assalamualaikum \nCinta adalah Kenyamanan..Kamu tau bahwa dunia kejam..Tapi tak selamanya dunia ini kejam..Ada hal yang indah didalamnya tanpa kelam.Yang inginku ciptakan yaitu..Dunia yang sangat nyaman..Nyaman untuk kau tempati...Meskipun suatu saat nanti kau marah..Tak apa asal kau tak sampai berdarah..Dan akupun berusaha untuk tidak membalasnya dengan amarah..Tapi menunjukan jalan yang ter’arah..Untuk menuju hubungan yang indah..Lewat do’a dan ibadah..Sampai pada waktunya terdengar suara sah..pabila dipaksa untuk memilih..Antara kata cinta ataupun kasih..Ku tak akan memilih keduanya..Karena yang kurasakan..Lebih dari dua kata itu.")
                               cl.sendContact(to, Bmid)
                               cl.sendMessage(msg.to, "assalamualaikum \nAku cuma punya satu hati,,Yaitu untukmu seorang,,,Tak ada yang lain,,,Begitupun dengan cinta,,Cintaku hanya untukmu saat ini, esok dan selamanya. \nMencintaimu adalah anugerah untukku,,,Cintaku tulus apa adanya \nMengalir dari dalam hatiku sendiri,,,Mungkin orang lain bisa memberimu kebahagiaan lebih dariku,,Tapi aku cuma punya satu,,,Cinta dan Kesetiaan yang akan kuberikan padamu.")
                               cl.sendContact(to, Cmid)
                               cl.sendMessage(msg.to, "assalamualaikum \nCINTA ABADI \nPagi ini sedikit rintik oleh mendungnya hati,,,Kuracik kopi dan rindu hingga menusuk sanubari,,,Pandang kosong tersesat oleh kata hingga makna,,,Engkau kah akhir kutujukan jiwa,,,Ataukah berakhir pilu di simpang asa \nKopi pagi ini tak semanis kemarin pagi,,Oleh rasa yang kian lelap termakan masa,,,Ku coba ulangi racikan kopi dan cinta,,,Tuk sempurnakan tanya,,,Adakah benar kau mencintaiku sahaja \nSemakin ku racik kopi dan rindu,,Haruskah kutiadakan keduanya itu?,,Oleh kopi yang hilang pahitnya?,,Atau oleh rindu yang hilang laranya \nKuseduh kopi pagi ini,,,Kuracik dengan sebuah mimpi,,,Agar dapat kuseruput rindu darimu,,,Agar cinta ini abadi teruntukmu")
                               cl.sendContact(to, Zmid)
                               cl.sendMessage(msg.to, "ASSALAMUALAIKUM \nSyair lagu cinta...mengalun bak untaian mutiara..indah lembut merasuk dikalbu...terbangkan berjuta angan dan mimpi indah bersamamu..darimu cinta bersemayam dihatiku bagai kapal dihempas gelombang terombang-ambing menantikan kepastian cinta darimu..")
                        ...
                        elif cmd == "tikungan on" or cmd == "nikung on":
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              try:
                                  tz = pytz.timezone("Asia/Jakarta")
                                  timeNow = datetime.now(tz=tz)
                                  cl.sendMessage(msg.to, "✍Cek tikungan diaktifkan\n\n✍Tanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\n✍Jam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              if msg.to in cctv['point']:
                                  ...
                                  cl.sendMessage(msg.to, "✍Cek tikungan dinonaktifkan\n\n✍Tanggal : "+ datetime.strftime(timeNow,'%Y-%m-%d')+"\n✍Jam [ "+ datetime.strftime(timeNow,'%H:%M:%S')+" ]")
                              else:
...
#===========Hiburan============#
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                                ...
                                num =  int(strnum)
                                wait["limit"] = num
                                cl.sendText(msg.to,"✍Total " +strnum)
...
#===========COMMAND ON OFF============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                ...
                                cl.sendText(msg.to,"Auto respon gift diaktifkan")

                        elif cmd == "respon2 off" or text.lower() == 'respon2 off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["Mentiongift"] = False
                                cl.sendText(msg.to,"Auto respon2 dinonaktifkan")
                                
                        elif cmd == "respon3 on" or text.lower() == 'respon3 on':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["detectMention3"] = True
                                cl.sendText(msg.to,"Auto respon3 diaktifkan")

                        elif cmd == "respon3 off" or text.lower() == 'respon3 off':
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                wait["detectMention3"] = False
                                cl.sendText(msg.to,"Auto respon3 dinonaktifkan")
                            ...
                            if msg._from in admin:
                              if wait["blacklist"] == {}:
                                ...
                                for m_id in wait["blacklist"]:
                                    ...
                                    ma += str(a) + ". " +cl.getContact(m_id).displayName + "\n"
                                cl.sendMessage(msg.to,"✍MHK Blacklist User\n\n"+ma+"\nTotal「%s」Blacklist User" %(str(len(wait["blacklist"]))))
                            ...
                            if msg._from in admin:
                              if wait["Talkblacklist"] == {}:
                                ...
                                for m_id in wait["Talkblacklist"]:
                                    ...
                                    ma += str(a) + ". " +cl.getContact(m_id).displayName + "\n"
                                cl.sendMessage(msg.to,"✍MHK Talkban User\n\n"+ma+"\nTotal「%s」Talkban User" %(str(len(wait["Talkblacklist"]))))
